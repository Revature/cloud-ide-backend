...
from app.api.routes import authenticate, users, runners, machines, images, app_requests, theia_requests  # Import your new images route

api_router = APIRouter()
api_router.include_router(users.router, prefix="/v1/users", tags=["users"])
api_router.include_router(runners.router, prefix="/v1/runners", tags=["runners"])
api_router.include_router(authenticate.router, prefix="/v1/machine_auth", tags=["auth"])
